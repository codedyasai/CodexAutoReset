...
[assembly: InternalsVisibleTo("CodexResetGuard.Tests")]
...
internal static class Program
{
        ...
        string? appDataRootOverride = null)
    {
        ...
        {
            Console.Error.WriteLine("CodexResetGuard currently supports Windows only.");
            return 2;
        }
        ...
        {
            Console.Error.WriteLine("CodexResetGuard is already running.");
            return 4;
        }
    ...
    {
        Console.WriteLine("CodexResetGuard");

...
public sealed class StartupService
{
    ...
    internal const string OwnershipSubKey = @"Software\CodexResetGuard\Startup";
    internal const string RunValueName = "CodexResetGuard";
    internal const string OwnerValueName = "OwnerId";

    private const int MaximumCommandLength = 2048;
    private const string ExpectedExecutableName = "CodexResetGuard.exe";
    ...
    {
        var validatedPath = ValidateExecutablePath(executablePath, requireExists: true);
        ...
        out Guid owner)
    {
        ...
        try
        {
            path = ValidateExecutablePath(path, requireExists: false);
        }

...
public sealed class ProtocolParserTests
{
    ...
    public void InitializeResponseRequiresAllStableFields()
    {
        using var valid = JsonDocument.Parse(
            """
            {
              ...
              "platformOs": "windows",
              "userAgent": "Codex Desktop/0.144.5 (Windows 10.0.26200; x86_64) unknown (codex_reset_guard; 0.1.0)"
            }
            """);
        Assert.IsTrue(
    ...
    public void InitializeResponsePinsLiveConsumeToAuditedServerVersion()
    {
        using var future = JsonDocument.Parse(
            """
            {
              ...
              "platformFamily": "windows",
              "platformOs": "windows",
              "userAgent": "Codex Desktop/0.145.0 (Windows 10.0.26200; x86_64) unknown (codex_reset_guard; 0.1.0)"
            }
            """);
    ...
    [DataTestMethod]
    [DataRow("Codex Desktop/0.144.50 (Windows) unknown (codex_reset_guard; 0.1.0)")]
    [DataRow("xCodex Desktop/0.144.5 (Windows) unknown (codex_reset_guard; 0.1.0)")]
    [DataRow("Codex Desktop/0.144.5 (codex_reset_guard; 0.1.0)")]
    [DataRow("Codex Desktop/0.144.5     (codex_reset_guard; 0.1.0)")]
    [DataRow("Codex Desktop/0.144.5 (Windows) unknown (codex_reset_guard; 0.1.0)x")]
    ...
    [DataRow("codex_reset_guard/0.144.5")]
    [DataRow("Codex Desktop/0.144.5")]
    [DataRow("Codex Desktop/0.144.5 (Windows) unknown (other_client; 0.1.0)")]
    [DataRow("Codex Desktop/0.144.5 (Windows) unknown (codex_reset_guard; 0.2.0)")]
    ...
    public void InitializeResponseRejectsUnsafeUserAgent()
    {
        var json = JsonSerializer.Serialize(new
        {
            ...
            platformFamily = "windows",
            platformOs = "windows",
            userAgent = "Codex Desktop/0.144.5 (codex_reset_guard; 0.1.0)\u0001",
        });
        ...
        string clientVersion)
    {
        using var response = CreateInitializeResponse(
            "Codex Desktop/0.144.5 (Windows) unknown (codex_reset_guard; 0.1.0)");
